...
def show_like_interface(screen):
    ...
    background1 = pygame.image.load('confessSuccessBgp.jpg').convert()
...
def show_unlike_interface(screen):
    screen.fill((255, 255, 255))
    background_1 = pygame.image.load('confessFailBgp.jpg').convert()
...
def main():
    ...
    # 添加背景音乐
    pygame.mixer.music.load('confessBgm.mp3')
    ...
    while running:
        ...
        screen.fill((255, 255, 255))
        # 添加背景图
        background = pygame.image.load('confessBgp.jpg').convert()
        ...
        # 设置标题及按钮文本信息
        title('如果有一天我向你表白，你会怎么样？', screen, scale=[8, 3])
        ...
        # if num < len(button_text):
        #     button(button_text[num], unlike_pos_x, unlike_pos_y - 50, unlike_pos_width, unlike_pos_height, (255, 255, 255), screen, (192, 0, 0))
